...
public class ValidatedCreativeApiaryScreen extends ContainerScreen<ValidatedCreativeApiaryContainer> {
    ...
    private CreativeApiaryTileEntity apiaryTileEntity;
    ...
    public ValidatedCreativeApiaryScreen(ValidatedCreativeApiaryContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    private void addTabButtons() {
        ...
        this.addButton(new TabImageButton(t+1, j+17, 18, 18, 110, 0, 18, TABS_BG, new ItemStack(ModItems.BEE_JAR.get()), 1, 1,
            ...
            public void renderToolTip(@Nonnull MatrixStack matrix, int mouseX, int mouseY) {
                ...
                ValidatedCreativeApiaryScreen.this.renderTooltip(matrix, s, mouseX, mouseY);
            }
        }).active = false;
    ...
    private void importBee() {
        CreativeNetPacketHandler.sendToServer(new CreativeImportBeeMessage(this.menu.getPos()));
    }
