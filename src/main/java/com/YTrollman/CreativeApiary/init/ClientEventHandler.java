...
import com.YTrollman.CreativeApiary.gui.CreativeApiaryBreederScreen;
...
public class ClientEventHandler {
    ...
    private static void doClientStuff(final FMLClientSetupEvent event) 
    {
        ...
        ScreenManager.register(ModContainers.CREATIVE_APIARY_BREEDER_CONTAINER.get(), CreativeApiaryBreederScreen::new);
    }
}